...
type FoodwheelClient interface {
	...
	AddCuisine(ctx context.Context, in *Cuisine, opts ...grpc.CallOption) (*Empty, error)
...
func (c *foodwheelClient) AddCuisine(ctx context.Context, in *Cuisine, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type FoodwheelServer interface {
	...
	// AddCuisine adds a new Cuisine to the database
	AddCuisine(context.Context, *Cuisine) (*Empty, error)
	// Spin returns a random Cuisine
...
func (UnimplementedFoodwheelServer) AddCuisine(context.Context, *Cuisine) (*Empty, error) {
